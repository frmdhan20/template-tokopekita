...
<body>
	...
	<div class="logo_products">
		<div class="container">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">CV.AMINCOMP</a></h1>
			</div>
			<div class="w3l_search">
				<form action="search.php" method="post">
					<input type="search" name="Search" autocomplete="off" placeholder="Cari produk...">
	...
	<ul id="demo1">
		<li>
			<img src="images/950x40-2.jpeg" alt="" />
		</li>
		<li>
			<img src="images/950x40-3.jpeg"/>
		</li>

		<li>
			<img src="images/950x40.jpeg"/>
		</li>
	</ul>
	<!-- //main-slider -->
	...
	<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jl.Ronggojalu No.270A Leces Probolinggo</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">amincomp@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>(0335) 680 394</li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>Copyright © CV.Amincomp 2022</p>
			</div>
		</div>
